...
export const BODIES_1_5: CardBodies = {
  C1: {
    hi: {
      ...
      authority: {
        office: 'ज़िला विधिक सेवा प्राधिकरण (DLSA), ज़िला कोर्ट के अंदर · वन स्टॉप सेंटर · प्रोटेक्शन ऑफ़िसर',
    ...
    hinglish: {
      ...
      authority: {
        office: 'District Legal Services Authority (DLSA), zila court ke andar · One Stop Centre · Protection Officer',
    ...
    en: {
      ...
      authority: {
        office: 'District Legal Services Authority (DLSA), inside the district court · One Stop Centre · Protection Officer',
        askFor: 'DLSA Front Office; Protection Officer',
      },
    },
  ...
  C5: {
    ...
    hinglish: {
      ...
      authority: {
        office: 'DLSA (sign se pehle muft salaah) · Tehsil / Revenue office (mutation) · Lok Adalat',
    ...
    en: {
      ...
      authority: {
        office: 'DLSA (free advice before signing) · Tehsil / Revenue office (mutation) · Lok Adalat',
        askFor: 'DLSA Front Office; Tehsildar / Patwari',
      },
    },
    numbers: ['15100', '14454'],
